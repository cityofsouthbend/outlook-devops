...
module.exports = {
    ...
    create: function (context) {
        ...
        function checkPropertyIsRead(node) {
            var _a;
            const topExpression = utils_1.findTopLevelExpression(node);
            switch ((_a = topExpression.parent) === null || _a === void 0 ? void 0 : _a.type) {
                case experimental_utils_1.TSESTree.AST_NODE_TYPES.AssignmentExpression:
        ...
        return {
            Program() {
                apiReferences = utils_2.findOfficeApiReferences(context.getScope());
