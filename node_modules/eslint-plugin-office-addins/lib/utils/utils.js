...
exports.findPropertiesRead = exports.findOfficeApiReferences = exports.findTopLevelExpression = exports.isContextSyncIdentifier = void 0;
...
function findOfficeApiReferencesInScope(scope) {
    scope.references.forEach((reference) => {
        if (reference.isWrite() &&
            reference.writeExpr &&
            getFunction_1.isGetFunction(reference.writeExpr) &&
            reference.resolved) {
            ...
            if (load_1.isLoadReference(reference.identifier)) {
